"""Find_GIS_CrimeType_Ratio URL Configuration
...
from aholistic_framework import settings
...
urlpatterns = [
    ...
    url(r'^Search_GIS_DataSets/$', remoteuser.Search_GIS_DataSets, name="Search_GIS_DataSets"),
    ...
    url(r'^Find_GIS_CrimeType_Ratio/$', serviceprovider.Find_GIS_CrimeType_Ratio, name="Find_GIS_CrimeType_Ratio"),
    url(r'^View_GIS_CrimeType_Details/$', serviceprovider.View_GIS_CrimeType_Details, name="View_GIS_CrimeType_Details"),
    url(r'^Train_View_GIS_DataSets_Details/$', serviceprovider.Train_View_GIS_DataSets_Details, name="Train_View_GIS_DataSets_Details"),
